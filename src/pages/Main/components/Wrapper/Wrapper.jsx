...
const Wrapper = () => {
  ...
  let prefix = 'th';
  let month = '';
  if (tempMonth === 0) month = 'Jun';
  if (tempMonth === 1) month = 'Feb';
  if (tempMonth === 2) month = 'March';
  if (tempMonth === 3) month = 'April';
  if (tempMonth === 4) month = 'May';
  if (tempMonth === 5) month = 'June';
  if (tempMonth === 6) month = 'July';
  if (tempMonth === 7) month = 'August';
  if (tempMonth === 8) month = 'September';
  if (tempMonth === 9) month = 'October';
  if (tempMonth === 10) month = 'November';
  if (tempMonth === 11) month = 'December';
  if (day === 1) prefix = 'st';
  if (day === 2) prefix = 'nd';
  if (day === 3) prefix = 'rd';
